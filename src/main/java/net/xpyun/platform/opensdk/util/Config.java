...
public class Config {
     ...
     */
    public static final String USER_NAME = "1012191814@qq.com";
    /**
     * *必填*：开发者密钥 ：芯烨云后台注册账号后自动生成的开发者密钥，开发者用户注册成功之后，登录芯烨云后台，在【个人中心=》账号信息】下可查看开发者密钥
     *
     * 当前【xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx】只是样例，需修改再使用
     */
    public static final String USER_KEY = "a2ee592335d84f969caf6ebac7170826";
    /**
     ...
     */
    public static final String OK_PRINTER_SN = "1696EUWUZU2974A";
    /**
     * 生成通用的请求头
     *
